...
/**
 * Class MyModuleNewPageFunctionalTest.
 *
 ...
 *
 * @code
 * ./vendor/phpunit/phpunit/phpunit -c web/core/phpunit.xml --printer '\Drupal\Tests\Listeners\HtmlOutputPrinter' modules/custom/my_module/tests/src/Functional
 * @endcode
 *
 * @group my_module
 */
class MyModuleNewPageFunctionalTest extends BrowserTestBase {
